...
echo "Adding Offer <br><br><br><br><br><br><br><br><br><br><br>";
...
<body>
    ...
    <div class="offset-3 col-6">
        ...
        <form id="addOfferForm" action="addingOffer.php" method="GET" align="center">
            <label for="title">Title:</label>
            <input type="text" id="title" onkeydown="verif()" class="form-control"><br>
            <div id="title_error"></div>
            <label for="destination">Destination:</label>
            <input type="text" class="form-control" id="destination"><br>
            <div id="destination_error"></div>
            <label for="dd">Departure Date:</label>
            <input type="date" id="dd" class="form-control"><br>
            <div id="dd_error"></div>
            <label for="rd">Return Date:</label>
            <input type="date" id="rd" class="form-control"><br>
            <div id="rd_error"></div>
            <label for="price">Price:</label>
            <input class="form-control" type="number" id="price"><br>
            <div id="price_error"></div>
            <label for="av">Availability:</label>
            <input type="checkbox" id="av"><br>
    ...
    <button onclick="alert('Bonjouuuuuuuuuur')" >Test</button>
    <p>alert('test')</p>
    ...
    /*if(title.length < 2){
       // alert('title must have at least 3 caracters!')
        document.getElementById("title_error").innerHTML ="<p style='color:red'>title must have at least 3 caracters!</p>";
    }else{
        document.getElementById("title_error").innerHTML ="<p style='color:green'>title is valid!</p>";
